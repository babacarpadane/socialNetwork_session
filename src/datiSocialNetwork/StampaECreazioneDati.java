...
public class StampaECreazioneDati extends HttpServlet {
	...
	protected void doGet (HttpServletRequest request, HttpServletResponse response) 
		...
		char car[]= {'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 
		...
		response.getWriter().write(
				"Creato account numero " +String.valueOf(profilo.getCodice())+" associato a: "
		        +persona.getCognome()+" "+persona.getNome()+"\r\r"
				+ "Riepilogo dati account:\r\r\n"
